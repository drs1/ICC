...
source:
	mkdir -p bin
	fsc -deprecation -d bin -classpath .:tools/java-cup-11a.jar `find src -name "*.java"` `find src -name "*.scala"`
...
fuckshit: "rm ../.metadata/.plugins/org.eclipse.core.resources/*.snap"
